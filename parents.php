...
<![endif]-->
    ...
    <!--[if lt IE 9]>
                ...
                <script src="./ui/vendor/respond/respond.proxy.js"></script><![endif]--><!--[if lt IE 10]><![endif]-->
        ...
        <div class="page">
            <div class="header-wrapper wrapper">
                <div class="header-inner inner">
                        ...
                        <div class='search'>
                            <form class="form-inline" action="/pages/search" method="GET">
                                <table>
                                    <tbody>
                                        <tr>
                                            <td><input class="site-search" type="text" name="q" value="" placeholder="Click to search" speech="speech" x-webkit-speech="x-webkit-speech" onspeechchange="this.form.submit();" onwebkitspeechchange="this.form.submit();" /></td>
                                            <td><button type="submit" name="" value="Search" class="btn">
                    ...
                    <div class="tel-bar info-bar" style="display: none;" data-identify="telephone">
                        <div class='telephone-data'>
                            <p class="theme-telephone"><i class="fa-phone fa fa-fw"></i> 0113 3200 750</p>
                        </div>
                        <i class="fa fa-times-circle info-close" aria-hidden="true"></i>
                    </div>
                    <div class="mail-bar info-bar" style="display: none;" data-identify="mail">
                        <div class='mail-data'>
                            <p class="theme-email"><i class="fa-envelope fa fa-fw"></i> helpdesk@webanywhere.co.uk</p>
                        </div>
                        <i class="fa fa-times-circle info-close" aria-hidden="true"></i>
                    </div>
                        ...
                        <div class="right-box">
                            <div class="nav">
                                ...
                                <ul class='root dropdown'>
                                    ...
                                    <li class="item6 last-item"><a href="gallery.php">Gallery</a></li>
                                </ul>
                            </div><!-- end of nav -->
                            ...
                            <div class="nav-mobile-wrapper">
                                ...
                                <div class="nav-mobile-inner">
                                    ...
                                    <ul class='root standard'>
                                        ...
                                        <li class="item5"><a href="contact-us.html">Contact Us</a></li>
                                        <li class="item6 last"><a href="gallery.php">Gallery</a></li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="slideshow-wrapper">
                    <div id="theme-slideshow">
                        <div id="theme-slideshow-images"><img src="https://img.cdn.schooljotter2.com/sampled/19914511/1920/0/nocrop//" /></div>
                    </div>
            ...
            <div class="site_quicklinks">
                <div class="site_quicklinks_inner">
                    ...
                    <div class="theme-social"><a href="http://facebook.com/webanywhere" title="Facebook" class="theme-social-icon theme-facebook" target="_blank"><span class="fa-stack fa-1x">
                                <i class="fa fa-square fa-stack-2x sj-icon-background"></i>
                                <i class="fa fa-facebook fa-stack-1x fa-inverse sj-icon-foreground"></i>
                            </span></a><a href="http://twitter.com/webanywhere" title="Twitter" class="theme-social-icon theme-twitter" target="_blank"><span class="fa-stack fa-1x">
                                <i class="fa fa-square fa-stack-2x sj-icon-background"></i>
            ...
            <div class="content-wrapper wrapper">
                <ol class="bs3-breadcrumb">
                    <li class="bs3-active">Parents</li>
                </ol>
                    ...
                    <div class="footer-container">
                        <div class="footer-left">
                            <div class="footer-left-content">
                                <h1 class="theme-site-name">Pebbles Elementary</h1>
                                <p class="theme-address"><i class="fa-map-marker fa fa-fw"></i> 1930 Holy Crest, Mainway Meadows (1st), Waterfalls, Harare</p>
                                <p class="theme-telephone"><i class="fa-phone fa fa-fw"></i> +263 785 005 471</p>
                                <p class="theme-email"><i class="fa-envelope fa fa-fw"></i> pebbleselementary@gmail.com</p>
                            </div>
