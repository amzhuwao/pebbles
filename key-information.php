...
$events_query = "SELECT id, event_name, event_description, event_date, event_location, event_image, featured FROM events WHERE is_published = 1 ORDER BY event_date ASC LIMIT 6";
...
<head>
  ...
  <link
    type="text/css"
    href="./css/bosons-payload.css?v=1686342133"
    rel="stylesheet" />
  <link
    type="text/css"
    href="./vendor/mediaelement/mediaelementplayer.min.css?v=1686342134"
    rel="stylesheet" />
  <link
    type="text/css"
    href="./css/sj._cmsfrontend.css?v=1686342133"
    rel="stylesheet" />
  <link
    type="text/css"
    href="./css/sj.sitesfrontend.css?v=1686342133"
    rel="stylesheet" />
  <link
    type="text/css"
    href="./css/print.css?v=1686342133"
    rel="stylesheet"
    media="print" />
  <!--[if lt IE 10
      ]><link
        type="text/css"
        href="./css/main.css?v=1686342133"
        rel="stylesheet"
      />
    <![endif]-->
  <link
  ...
  <link
    type="text/css"
    id="theme-stylesheet"
    href="./bespokethemes/pebbles_deluxe_theme/css/slick-theme.css?v=1697112485"
    rel="stylesheet" />
  <link
    type="text/css"
    id="theme-stylesheet"
    href="./bespokethemes/pebbles_deluxe_theme/css/mobile_nav_core.css?v=1697112485"
    rel="stylesheet" />
  <link
    type="text/css"
    id="theme-stylesheet"
    href="./bespokethemes/pebbles_deluxe_theme/css/mobile_nav_layout.css?v=1697112485"
    rel="stylesheet" />
  <link
    type="text/css"
    id="theme-stylesheet"
    href="./bespokethemes/pebbles_deluxe_theme/css/layout.css?v=1699015231"
    rel="stylesheet" />
  <link
    type="text/css"
    id="theme-stylesheet"
    href="./bespokethemes/pebbles_deluxe_theme/css/mobile-layout.css?v=1698664610"
    rel="stylesheet" />
  <style>
    .events-section {
      margin: 40px 0;
  ...
  <script
    ...
    src="./js/payloads/sun-payload.js?v=1748503802"></script>
  <script
    type="text/javascript"
    src="./js/payloads/venus-payload.js?v=1732008002"></script>
  <script
    type="text/javascript"
    src="./js/sj.sitesfrontend.js?v=1686342134"></script>
  <!--[if lt IE 9]>
      <script src="./vendor/html5shiv/html5shiv.js?v=1686342134"></script>
      <script src="./ui/vendor/respond/respond.min.js"></script>
      <link
        href="./vendor/respond/respond-proxy.html"
        id="respond-proxy"
        rel="respond-proxy" />
      <link
  ...
  <script
    type="text/javascript"
    src="./bespokethemes/pebbles_deluxe_theme/js/detectr.min.js?v=1697112486"></script>
  <script
    type="text/javascript"
  ...
  <title>Pebbles Elementary - Key Information</title>
  <link rel="canonical" href=".//key-information" />
...
<body
  class="page-key-information app-site pebbles_deluxe_theme tenant-type-unknown sj sj_preview has-side-menu">
              ...
              <div class="nav">
                <ul class="root dropdown">
                  ...
                  <li class="item3 parent">
                    ...
                    <ul>
                      <li class="item1">
                        <a href="about-us.php#staff">Staff</a>
                      </li>
                    </ul>
                  </li>
                  <li class="item4"><a href="parents.php">Parents</a></li>
                  <li class="item5">
        ...
        <div class="slideshow-wrapper">
          <div id="theme-slideshow">
            <div id="theme-slideshow-images">
              <img
                src="https://img.cdn.schooljotter2.com/sampled/19914511/1920/0/nocrop//" />
            </div>
          </div>
      ...
      <div class="site_quicklinks">
        <div class="site_quicklinks_inner">
          ...
          <div class="theme-social">
            <a
              href="http://facebook.com/webanywhere"
              title="Facebook"
              ...
              href="http://twitter.com/webanywhere"
              title="Twitter"
      ...
      <div class="content-wrapper wrapper">
        <div class="content-inner inner">
            ...
            <div
              ...
              <div
                ...
                <div class="column column-1col">
                  <div id="element_125293552" class="element element-text">
                    <h2 style="text-align: center">Key Information</h2>
                    <p style="text-align: center">
                      This section provides important information to help
                      parents, guardians, and visitors understand how our
                      school operates. Here you will find essential details
                      about school policies, term dates, admissions,
                      attendance, uniforms, safeguarding, and daily routines.
                    </p>
                    <p style="text-align: center">
                      We aim to keep this information clear, up to date, and
                      easy to access, supporting open communication between
                      the school and families. If you require any additional
                      details or clarification, please do not hesitate to
            ...
            <div
              ...
              <div
                ...
                <div class="column column-2col-1">
                  <div id="element_125293553" class="element element-files">
                    <div class="sj_element_files">
                      <div class="bs3-list-group">
                        <table
                          class="bs3-table bs3-table-bordered sj-table-background-light">
                          <thead>
                            <tr>
                              <th>Name</th>
                              <th></th>
                          ...
                          <tbody>
                            <tr class="sj_files_row_file">
                              <td>
                                <span class="file"><i class="fa-fw fa fa-file-text-o"></i>&nbsp;Test document.odt</span>
                              </td>
                              <td class="td_action bs3-text-right">
                                <a
                                  href="/downloadfile/12200555"
                                  class="download bs3-btn bs3-btn-xs bs3-btn-primary">Download</a>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                        <div class="sj-summation bs3-text-right">
                          Showing <b>1-1</b> of <b>1</b>
                        </div>
                      </div>
                      <script>
                        SJ.CMSFrontend.Elements.async_file_list(125293553);
                      </script>
                    </div>
                  </div>
                </div>
                <div class="column column-2col-2">
                  <div
                    id="element_125293554"
                    class="element element-document">
                    <div class="sj_element_document">
                      <div
                        class="sj_element_document_container sj-block-center"
                        style="width: 100%"
                        data-fixheight="60">
                        <div
                          id="sj_element_document_125293554"
                          data-pdf="https://img2.cdn.schooljotter2.com/document/555/12200555.pdf"
                          style="
                              width: 100%;
                              height: 100%;
                              position: relative;
                      ...
                      <div class="sj-block-center" style="width: 100%"></div>
                      <div
                        id="sj_element_document_link_125293554"
                        class="sj_element_document_download">
                        <a href="/downloadfile/12200555"><i class="fa-download fa fa-fw"></i> Download
                          Document</a>
                      </div>
                      <script>
                        $(function() {
                          SJ.Conversion.Document.init(
                            "125293554",
                            "12200555",
                            true,
                          );
          ...
          <div class="events-section">
            <h2 style="text-align: center; margin-bottom: 10px;">Upcoming Events</h2>
              ...
              if ($events_result && $events_result->num_rows > 0) {
                while ($event = $events_result->fetch_assoc()) {
                  ...
                  if (!empty($event['event_image'])) {
                    echo '<div class="event-image"><img src="' . htmlspecialchars($event['event_image']) . '" alt="' . htmlspecialchars($event['event_name']) . '" /></div>';
                  } else {
                    echo '<div class="event-image">No Image</div>';
                  }
                  ...
                  echo '<h3 class="event-name">' . htmlspecialchars($event['event_name']) . '</h3>';

                  echo '<div class="event-meta">';
                  echo '<span class="event-date">📅 ' . htmlspecialchars($formatted_date) . ' at ' . htmlspecialchars($formatted_time) . '</span>';
                  echo '</div>';

                  if (!empty($event['event_location'])) {
                    echo '<div class="event-meta"><span class="event-location">📍 ' . htmlspecialchars($event['event_location']) . '</span></div>';
                  }

                  echo '<div class="event-description">' . htmlspecialchars($description) . '</div>';
                  echo '</div>';
                  echo '</div>';
                }
              } else {
                echo '<p style="grid-column: 1/-1; text-align: center; color: #666;">No upcoming events at this time.</p>';
              }
              ?>
            </div>
          </div>
      ...
      <div class="footer-wrapper wrapper">
        ...
        <script>
          (function() {
            ...
            ws.async = true;
            ws.src =
              "https://stats.sites.schooljotter2.com/32561/1387243/hits.js?v=" +
              Math.random();
